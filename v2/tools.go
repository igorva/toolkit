...
// RandomString returns a string of random characters of lenght n, using randomStringSource as a source for the string.s
...
// DownloadStaticFile downloads a file, and tries to force the browser to avoid displaying it in the browser window by setting content disposition.
...
func (t *Tools) ReadJSON(w http.ResponseWriter, r *http.Request, data interface{}) error {
	...
	// Checking if there is more than one json in this body
